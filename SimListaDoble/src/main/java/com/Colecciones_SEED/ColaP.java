...
public class ColaP<T> extends Cola<T>{
    ...
    /**
     * Metodo que permite clonar la informacion de una Cola de prioridad generando una nueva ColaP. <br>
     * @return Un objeto de tipo ColaP<T> con la informacion actual de la Cola clonada.
     */
